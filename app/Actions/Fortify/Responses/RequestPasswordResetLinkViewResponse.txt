...
use App\Actions\Fortify\Responses\RequestPasswordResetLinkViewResponse as CustomRequestPasswordResetLinkViewResponse;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(RequestPasswordResetLinkViewResponse::class, CustomRequestPasswordResetLinkViewResponse::class);
